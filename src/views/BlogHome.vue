    ...
    <div class="container">
      ...
      <header class="buttercms">
        <a
          ...
          ><img
            class="img2"
            src="../components/butter-y.png"
            alt="création de site internet sur mesure butter cms"
            title="blog butter cms"
        /></a>
      </header>
          ...
          >
            ...
            <div :id="titre2(index)">
              ...
              <div class="commentaire">
                <h4>
                  <i class="fa fa-comment-o"></i><i class="fa fa-calendar"></i>
                  {{ mydate(post.published) }}
                </h4>
              </div>
            </div>
